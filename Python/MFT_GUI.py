...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1100, 889)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.Sensitivity_Slider = QtWidgets.QSlider(self.centralwidget)
        self.Sensitivity_Slider.setGeometry(QtCore.QRect(70, 450, 160, 22))
        ...
        self.Sensitivity_Label.setGeometry(QtCore.QRect(100, 420, 101, 21))
        ...
        self.Enter_Cmd_Line.setGeometry(QtCore.QRect(330, 770, 381, 21))
        ...
        self.WAC_View_Frame = QtWidgets.QFrame(self.centralwidget)
        self.WAC_View_Frame.setGeometry(QtCore.QRect(60, 30, 471, 341))
        self.WAC_View_Frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.WAC_View_Frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.WAC_View_Frame.setObjectName("WAC_View_Frame")
        self.Version_Label = QtWidgets.QLabel(self.centralwidget)
        self.Version_Label.setGeometry(QtCore.QRect(440, 850, 161, 16))
        self.Version_Label.setObjectName("Version_Label")
        self.MZC_View_Frame = QtWidgets.QFrame(self.centralwidget)
        self.MZC_View_Frame.setGeometry(QtCore.QRect(570, 30, 471, 341))
        self.MZC_View_Frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.MZC_View_Frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.MZC_View_Frame.setObjectName("MZC_View_Frame")
        self.Output_View_Frame = QtWidgets.QFrame(self.centralwidget)
        self.Output_View_Frame.setGeometry(QtCore.QRect(330, 400, 471, 341))
        self.Output_View_Frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.Output_View_Frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.Output_View_Frame.setObjectName("Output_View_Frame")
        ...
        self.Settings_Label.setGeometry(QtCore.QRect(130, 380, 51, 31))
        font = QtGui.QFont()
        ...
        self.Send_Cmd_Button.setGeometry(QtCore.QRect(710, 760, 185, 41))
        self.Send_Cmd_Button.setObjectName("Send_Cmd_Button")
        self.Screw_Type_List = QtWidgets.QComboBox(self.centralwidget)
        self.Screw_Type_List.setGeometry(QtCore.QRect(70, 500, 161, 22))
        ...
        self.Screw_Type_Label.setGeometry(QtCore.QRect(120, 480, 61, 21))
        self.Screw_Type_Label.setObjectName("Screw_Type_Label")
        self.MFT_Logo = QtWidgets.QLabel(self.centralwidget)
        self.MFT_Logo.setGeometry(QtCore.QRect(810, 380, 271, 281))
        self.MFT_Logo.setText("")
        self.MFT_Logo.setPixmap(QtGui.QPixmap("MFT V1.png"))
        self.MFT_Logo.setObjectName("MFT_Logo")
        self.MZC_Port_List = QtWidgets.QComboBox(self.centralwidget)
        self.MZC_Port_List.setGeometry(QtCore.QRect(70, 670, 161, 22))
        ...
        self.WAC_Port_Label.setGeometry(QtCore.QRect(90, 590, 121, 21))
        self.WAC_Port_Label.setObjectName("WAC_Port_Label")
        self.Serial_Port_List = QtWidgets.QComboBox(self.centralwidget)
        self.Serial_Port_List.setGeometry(QtCore.QRect(70, 730, 161, 22))
        ...
        self.Serial_Port_Label.setGeometry(QtCore.QRect(110, 710, 81, 21))
        self.Serial_Port_Label.setObjectName("Serial_Port_Label")
        self.WAC_Port_List = QtWidgets.QComboBox(self.centralwidget)
        self.WAC_Port_List.setGeometry(QtCore.QRect(70, 610, 161, 22))
        ...
        self.COM_Port_Label.setGeometry(QtCore.QRect(120, 550, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setUnderline(True)
        ...
        self.MZC_Port_Label.setGeometry(QtCore.QRect(90, 650, 121, 21))
        self.MZC_Port_Label.setObjectName("MZC_Port_Label")
        self.Tighten_Button = QtWidgets.QPushButton(self.centralwidget)
        self.Tighten_Button.setGeometry(QtCore.QRect(890, 750, 161, 81))
        font = QtGui.QFont()
        ...
        self.Tune_Button.setGeometry(QtCore.QRect(890, 650, 161, 81))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.Status_Browser.setGeometry(QtCore.QRect(330, 820, 381, 41))
        self.Status_Browser.setObjectName("Status_Browser")
        self.Status_Label = QtWidgets.QLabel(self.centralwidget)
        self.Status_Label.setGeometry(QtCore.QRect(330, 800, 91, 21))
        ...
        self.Output_View_Frame.raise_()
        self.Screw_Type_List.raise_()
        self.Settings_Label.raise_()
        self.Version_Label.raise_()
        self.WAC_View_Frame.raise_()
        self.MZC_View_Frame.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Screw_Type_List.setItemText(1, _translate("MainWindow", "New Item"))
